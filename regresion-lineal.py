#Librerias
#py -m pip install nombrelibreria
...
datos = pd.read_csv('C:\\Users\\Ñañanga\\Desktop\\TrabajoGSS\\Algoritmos\\datos_ACPM2.csv', sep=",", skiprows=32, usecols=[2,3])
print(datos)
...
for i in range(nits):
    ...
    if (i+1)%1000 == 0:
        ...
        print("    Margen de error: {}".format(error[i]))
        print("=======================================")
